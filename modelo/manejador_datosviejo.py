...
def obtener_estado_esp32():
    """Comprueba en la BD si ha entrado algun dato en los ultimos 15 segundos"""
    conexion = conectar()
    if conexion:
        try:
            cursor = conexion.cursor(dictionary=True)
            ...
            if res and res['ultimo']:
                ...
                return diferencia.total_seconds() < 15
        except: pass
        finally: conexion.close()
    return False
...
# --- AQUÍ ESTÁ LA FUNCIÓN RESTAURADA QUE EVITA EL ERROR DE LA CONSOLA ---
