...
from vista import vista_login, vista_dashboard_sensores, vista_camaras # Importa las Vistas
...
def main(page: ft.Page):
    ...
    def route_change(route):
        ...
        # INICIO DE LA TAREA: Añadir y Proteger la ruta /camaras
        elif page.route == "/camaras":
            if rol: # Tarea: Proteger la ruta /camaras (requiere sesión)
                # Tarea: En main.py, añadir la ruta /camaras a route_change
                page.views.append(
                    vista_camaras.crear_vista_camaras(page)
                )
            else:
                # Si no está logueado, forzar al login (aunque ya se chequea al inicio)
                page.go("/login")
...
if __name__ == "__main__":
    # Importante: añadimos 'assets_dir="assets"' para que ft.Image pueda cargar 'camara_sim.jpg'
