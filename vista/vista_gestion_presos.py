...
def crear_dialogo_preso(titulo, on_guardar, preso_actual=None):
    ...
    Si preso_actual tiene datos, pre-rellena los campos.
    """
...
def crear_vista_presos(lista_presos, on_abrir_crear_handler, on_abrir_editar_handler, on_refrescar_handler,
    ...
    """
    Crea la tarjeta de gestión de presos con altura limitada.
    """
    ...
    # --- CONTENEDOR LIMITADO ---
    # AQUÍ LIMITAMOS LA ALTURA. 200px es aprox 3 elementos.
    ...
    return ft.Container(
        ...
        border_radius=10,
        padding=15,
        expand=True,  # El contenedor PADRE sí se expande en anchura
        content=ft.Column([
            top_row,
